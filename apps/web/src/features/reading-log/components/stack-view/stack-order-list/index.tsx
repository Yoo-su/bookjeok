...
interface StackOrderListProps {
  books: ReadingStackBook[];
  onBookClick: (book: ReadingStackBook) => void;
}
 ...
 */
export const StackOrderList = memo(
  forwardRef<HTMLElement, StackOrderListProps>(function StackOrderList(
    { books, onBookClick },
    ref,
  ) {
