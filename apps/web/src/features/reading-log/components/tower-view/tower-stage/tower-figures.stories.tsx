...
import { TOWER_AUTHOR_IDS } from "../lib/authors";
import { buildFigure } from "../lib/figure";
import { SceneNodes } from "../lib/scene-svg";
import type { Mood, SceneColors, TowerCharacter } from "../lib/types";
...
export const Authors: Story = {
  args: { characters: TOWER_AUTHOR_IDS, moods: ["calm"] },
};
export const Lineup: Story = {
  args: { characters: ["M", "F", ...TOWER_AUTHOR_IDS], moods: ["happy"] },
};
/** 얼굴을 크게 본다 */
