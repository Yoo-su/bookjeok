...
import type {
  TowerAuthor,
  TowerReaderCharacter,
} from "../components/tower-view/lib/types";
...
export const TOWER_DEFAULT_HEIGHT: Record<TowerReaderCharacter, number> = {
  M: 173,
  F: 161,
};
...
interface TowerSettingsState {
  ...
  character: TowerReaderCharacter | null;
  author: TowerAuthor | null;
  setHeightCm: (heightCm: number) => void;
  setCharacter: (character: TowerReaderCharacter) => void;
  setAuthor: (author: TowerAuthor | null) => void;
}
