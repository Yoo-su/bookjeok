...
import { TowerHeightCard } from "@/features/reading-log/components/tower-view/tower-height-card";
...
describe("TowerHeightCard 키 입력", () => {
  ...
  it("범위를 벗어난 채로 벗어나면 오류를 띄우고 입력칸과 잇는다", () => {
    ...
    expect(input).toHaveAttribute("aria-describedby", "tower-height-error");
